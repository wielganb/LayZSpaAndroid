...
## Smart Spa 0.8.12
- Usunięto całkowicie system powiadomień Android.
- Usunięto moduł powiadomień, monitorowanie ESP w tle oraz odbiorniki powiadomień.
- Aplikacja nie prosi już o uprawnienie do powiadomień i nie tworzy alarmów w tle.
- Połączenie WebSocket działa wyłącznie z głównego ekranu aplikacji, bez dodatkowego połączenia z monitora tła.
