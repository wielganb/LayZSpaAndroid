...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView weatherTitle,weatherDetails,weatherRecommendation,smartAiSummary; private MaterialButton weatherRefresh,weatherSetButton,weatherLocationButton,smartAiBar;
    ...
    private View buildMain(){
        ...
        // Zamiast dużej karty pogodowej: mały pasek AI. Szczegóły wyskakują po kliknięciu.
        MaterialCardView aiCard=card();
        aiCard.setRadius(dp(16));
        LinearLayout aiRow=inside(aiCard,dp(7));
        ...
        LinearLayout.LayoutParams aiSummaryLp=new LinearLayout.LayoutParams(0,dp(36),1);
        aiSummaryLp.setMargins(dp(7),0,dp(2),0);
        aiRow.addView(smartAiBar,new LinearLayout.LayoutParams(dp(158),dp(36)));
        aiRow.addView(smartAiSummary,aiSummaryLp);
        smartAiBar.setOnClickListener(v->showSmartAiDialog());
        smartAiSummary.setOnClickListener(v->showSmartAiDialog());
